  ...
  <div class="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
    ...
    <div class="relative">
      ...
      <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-gray-900/30 p-6">
        <!-- 分类标签区域 -->
        <div class="flex flex-wrap gap-3 mb-8">
          <button
            ...
            :class="[
              'px-5 py-2.5 text-sm font-medium rounded-full transition-all duration-300 flex items-center shadow-sm',
              activeCategory === category.id
                ? 'bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-blue-200 dark:shadow-blue-900/30'
                : 'bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 hover:shadow'
            ]"
          >
            ...
            {{ category.name }}
            <span class="ml-2 px-2.5 py-0.5 text-xs rounded-full" :class="[
              activeCategory === category.id
                ? 'bg-blue-700/30 text-white'
                : 'bg-gray-200/70 dark:bg-gray-600/70 text-gray-600 dark:text-gray-300'
            ]">
              {{ category.count }}
            </span>
          </button>
        ...
        <div class="space-y-4">
          <div
            ...
            class="group bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700 p-5 hover:shadow-md dark:hover:shadow-gray-900/30 transition-all duration-300 ease-in-out cursor-pointer transform hover:-translate-y-1"
          >
            <div class="flex items-start space-x-4">
              <!-- 图标 -->
              <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg transition-colors duration-300 group-hover:bg-blue-50 dark:group-hover:bg-blue-900/30">
              ...
              <div class="flex-1">
                <div class="flex items-start justify-between mb-2">
                  ...
                  <span
                    ...
                    class="flex-shrink-0 ml-2 px-3 py-1 text-xs font-medium bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-full"
                  >
                    NEW
                  </span>
                </div>
              ...
              <!-- 箭头图标 -->
              <div class="text-gray-400 dark:text-gray-500 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-all duration-300 transform translate-x-0 group-hover:translate-x-2">
